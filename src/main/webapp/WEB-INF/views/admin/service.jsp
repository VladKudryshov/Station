                ...
                <div class="row">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="float: left;"><spring:message code="page.listService"/></h3>
                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach var="service" items="${listService}">
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-default" onclick="document.location.href='/service/${service.id}/edit'"><i class="fa fa-plus-square"></i> <spring:message code="table.button.edit"/> </button>
                                            <button type="button" class="btn btn-danger" onclick="document.location.href='/service/delete/${service.id}'"><i class="fa fa-trash-o"></i><spring:message code="table.button.delete"/></button>
                                        </td>
                                    </tr>
