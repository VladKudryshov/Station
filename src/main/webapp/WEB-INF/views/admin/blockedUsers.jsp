                ...
                <div class="row">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title"><spring:message code="page.blockUsers"/></h3>
                        </div>
                                    ...
                                    <c:forEach var="user" items="${blockedUsers}">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-warning" onclick="document.location.href='/user/${user.id}/changerole'"> <spring:message code="table.button.unblock"/></button>
